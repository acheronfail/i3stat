...
impl Interface {
    pub fn new(name: impl AsRef<str>, addr: impl AsRef<str>, flags: InterfaceFlags) -> Interface {
        Interface {
    ...
    pub fn get_interfaces() -> Result<Vec<Interface>, Box<dyn Error>> {
        ...
        for if_addr in if_addrs.into_iter() {
            ...
            interfaces.push(Interface::new(if_addr.interface_name, addr, if_addr.flags));
        }
