// See: https://github.com/jnqnfe/pulse-binding-rust/pull/49
...
use libpulse_binding::mainloop::api::{
    DeferEventCb,
    DeferEventDestroyCb,
    IoEventCb,
    IoEventDestroyCb,
...
use libpulse_binding::mainloop::events::io::{FlagSet as IoEventFlagSet, IoEventInternal};
